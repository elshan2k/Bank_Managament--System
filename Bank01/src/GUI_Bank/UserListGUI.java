...
public class UserListGUI extends javax.swing.JFrame {
    ...
    public void addRowToJTable() {
        ...
        for (int i = 1; i < Bank.ar.getSize(); i++) {
            rowData[0] = Bank.ar.getUser(i).getId();
            rowData[1] = Bank.ar.getUser(i).getName();
            rowData[2] = Bank.ar.getUser(i).getSurname();
            rowData[3] = Bank.ar.getUser(i).getBalance();
            rowData[4] = Bank.ar.getUser(i).getEmail();
            rowData[5] = Bank.ar.getUser(i).getAddress();
            rowData[6] = Bank.ar.getUser(i).getDot();
        ...
        select.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!select.isSelectionEmpty()) {
                    selectedRow = select.getMinSelectionIndex()+1;
                    if (Bank.ar.getUser(selectedRow).isIsBlocked() == true) {
                        jToggleButton1.setSelected(true);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(900, 308));
        setResizable(false);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Surname", "Balance", "E-Mail", "Address", "Date of Birth"
            }
        ) {
